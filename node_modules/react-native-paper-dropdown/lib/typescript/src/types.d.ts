...
export type DropdownProps = {
    ...
    Touchable?: ForwardRefExoticComponent<PressableProps & React.RefAttributes<View>>;
...
} & Pick<TextInputProps, 'placeholder' | 'label' | 'mode' | 'disabled' | 'error'>;
export type MultiSelectDropdownProps = {
    ...
    onSelect?: (value: string[]) => void;
    CustomMenuHeader?: (props: DropdownHeaderProps) => JSX.Element;
    CustomMultiSelectDropdownItem?: (props: MultiSelectDropdownItemProps) => JSX.Element;
